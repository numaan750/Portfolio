...
export const skills = [
  ...
  { name: "TypeScript", level: 75, category: "Frontend", icon: "SiTypescript" },
  { name: "Redux", level: 88, category: "State Mgmt", icon: "SiRedux" },
  { name: "Context API", level: 85, category: "State Mgmt", icon: "SiReact" },
  ...
  { name: "Mongoose", level: 80, category: "Database", icon: "SiMongoose" },
  { name: "JWT / Auth", level: 82, category: "Security", icon: "SiJsonwebtokens" },
  { name: "Git & GitHub", level: 88, category: "Tools", icon: "SiGithub" },
  { name: "Postman", level: 85, category: "Tools", icon: "SiPostman" },
  { name: "Vercel", level: 83, category: "Tools", icon: "SiVercel" },
  { name: "Cloudinary", level: 80, category: "Tools", icon: "SiCloudinary" },
  { name: "Stripe", level: 75, category: "Payments", icon: "SiStripe" },
  { name: "Creem Payment", level: 70, category: "Payments", icon: "TbApi" },
  { name: "OpenAI API", level: 80, category: "AI", icon: "SiOpenai" },
  { name: "Claude API", level: 78, category: "AI", icon: "TbApi" },
  { name: "Gemini API", level: 72, category: "AI", icon: "SiGoogle" },
];
...
answer:
"I provide full-stack web development, custom web applications, UI/UX design, AI integrations, API development, and website optimization. Whether you need a business website, SaaS platform, or custom solution, I can help bring your idea to life.",
},
{
id: 2,
question: "What is your development process?",
answer:
"My process starts with understanding your goals and requirements. From there, I create a clear project plan, design the user experience, develop the application, perform testing, and ensure a smooth launch with ongoing support when needed.",
},
{
id: 3,
question: "How long does a project usually take?",
answer:
"Project timelines depend on the scope and complexity. A simple website may take 1–2 weeks, while larger applications such as SaaS platforms or custom systems can take several weeks. A detailed timeline is provided before development begins.",
},
{
id: 4,
question: "How do we communicate during the project?",
answer:
"Clear communication is a priority. I provide regular progress updates and stay available through email, WhatsApp, Zoom, or your preferred communication channel to ensure everything stays on track.",
},
{
id: 5,
question: "Do you offer support after the project is completed?",
answer:
"Yes. I provide post-launch support, bug fixes, performance improvements, and feature updates to ensure your website or application continues to run smoothly.",
},
{
id: 6,
question: "Can you work with existing websites or applications?",
answer:
"Absolutely. Whether you need new features, design improvements, performance optimization, or maintenance, I can work with existing projects and help enhance their functionality and user experience.",
},
];
