  ...
  return (
    <SectionWrapper id="contact" className="pt-15">
      <SectionHeader
        tag="Contact"
        title="Get in Touch"
        subtitle="Have a question, project idea, or business inquiry? Fill out the form below and I'll get back to you as soon as possible."
      />

      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        <motion.div variants={fadeLeft} className="flex flex-col gap-5 h-full">
          <div className="glass px-6 py-7">
            <h3 className="font-extrabold text-[1.15rem] mb-3">Let's Talk</h3>
            <p className="text-slate-400 text-[0.9rem] leading-[1.75] mb-6">
              Whether you're looking for a new website, a custom web application, professional advice, or simply want to learn more about my services, feel free to reach out. I'm always happy to discuss ideas and answer questions.
            </p>
            {[
              {
                icon: <FaEnvelope />,
          ...
          <div className="glass px-5.5 py-5 bg-cyan-400/5 border-cyan-400/20">
            ...
            <p className="text-slate-400 text-[0.82rem] mt-2">
              Available for project inquiries, business collaborations, and general consultations.
            </p>
          </div>
        </motion.div>
          ...
          <div className="glass px-6 py-6 h-full flex flex-col">
            {sent ? (
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className={`btn-primary w-full justify-center transition-opacity duration-200 ${loading ? 'opacity-70 pointer-events-none' : ''
                    }`}
                  disabled={loading}
                >
                  {loading ? (
