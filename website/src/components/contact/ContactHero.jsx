      ...
      <div className="group relative overflow-hidden rounded-4xl border border-white/10 bg-[#0f1320]/90 p-10 text-center transition-all duration-300 hover:border-indigo-500/40 hover:shadow-[0_0_40px_rgba(99,102,241,0.15)]">
        ...
        <div className="relative z-20">
          ...
          <p className="section-sub max-w-2xl mx-auto">
            Whether you have a project idea, need professional advice, have a business inquiry, or simply want to discuss an opportunity, feel free to get in touch. I'm always happy to connect and explore how I can help.          </p>
        </div>
      </div>
    </SectionWrapper>
  );
