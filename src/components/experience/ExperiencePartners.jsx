...
const PARTNERS = ["PulseTech", "EstatePro", "Neon Labs", "VShop", "Studio Nine"];
  ...
  return (
    <SectionWrapper className="pt-15 bg-[#07070f]">
      <div className="rounded-4xl border border-white/10 bg-[#0f1320]/90 p-8">
        ...
        <h2 className="section-title">Trusted by teams building modern SaaS and digital experiences.</h2>
