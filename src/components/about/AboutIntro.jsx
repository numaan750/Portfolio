...
const highlights = [
  { icon: <FaBolt className="text-indigo-400 text-2xl" />, title: "Fast Delivery", desc: "Projects delivered on time without compromising quality." },
  { icon: <FaBrain className="text-cyan-400 text-2xl" />, title: "AI Integration", desc: "OpenAI, Claude & Gemini APIs integrated in real apps." },
  { icon: <FaMobileAlt className="text-indigo-400 text-2xl" />, title: "Fully Responsive", desc: "Every project works perfectly on all screen sizes." },
  { icon: <FaShieldAlt className="text-cyan-400 text-2xl" />, title: "Secure & Scalable", desc: "JWT auth, REST APIs, and scalable MERN architecture." },
];
...
export default function AboutIntro() {
  return (
    <SectionWrapper id="about" className="pt-15">
      <SectionHeader
        tag="About Me"
        title="Full-Stack Developer with a passion for clean code and great UI"
        subtitle="I build fast, scalable, and visually polished web applications using the MERN stack and Next.js."
      />
        ...
        >
          <div>
            ...
            <p className="text-slate-400 leading-[1.85] text-[0.97rem]">
              I am Numaan Ali, a Full-Stack MERN Developer based in Lahore with 2+ years of experience. I have built AI-powered platforms, e-commerce stores, and SaaS dashboards for clients globally. I take pride in clean code and interfaces that users enjoy.
            </p>
          </div>
