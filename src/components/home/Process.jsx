      ...
      >
        {processSteps.map((step) => {
          ...
          return (
            ...
            >
              <div className="absolute inset-0 bg-linear-to-br from-[rgba(99,102,241,0)] to-[rgba(34,211,238,0)] group-hover:from-[rgba(99,102,241,0.05)] group-hover:to-[rgba(34,211,238,0.05)] transition-colors duration-[500ms] pointer-events-none" />
              ...
              <div className="relative z-[10] w-[56px] h-[56px] rounded-[12px]  flex items-center justify-center  text-[24px] mb-[24px] text-[#22d3ee] border border-[rgba(99,102,241,0.2)] bg-linear-to-br  from-[rgba(99,102,241,0.2)]  to-[rgba(34,211,238,0.2)] group-hover:scale-[1.1] transition-transform duration-[300ms]">
                {Icon && <Icon />}
              </div>
