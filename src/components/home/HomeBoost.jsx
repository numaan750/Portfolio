      ...
      <div className="rounded-3xl border border-white/10 bg-[#0c1221]/90 p-6 sm:p-8 shadow-[0_30px_100px_rgba(0,0,0,0.24)]">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center">
          ...
          <div className="flex-1 space-y-5 text-center lg:text-left">
            <p className="section-tag">Ready to Build?</p>
            <h2 className="section-title">Let's turn your idea into a fast, modern web application.</h2>
            <p className="section-sub mx-auto lg:mx-0">
              Whether you need a landing page, a full-stack SaaS, or an AI-powered platform — I deliver clean code, great UI, and on-time results.
            </p>
